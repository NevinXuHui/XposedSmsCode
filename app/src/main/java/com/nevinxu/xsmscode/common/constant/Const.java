package com.nevinxu.xsmscode.common.constant;
...
public interface Const {
    ...
    String WECHAT_KEY_EXTRA_DONATE = "nevinxuDonate";
    ...
    String PROJECT_SOURCE_CODE_URL = "https://github.com/nevinxu0725/XposedSmsCode";
    String PROJECT_GITHUB_LATEST_RELEASE_URL = PROJECT_SOURCE_CODE_URL + "/releases/latest";
    String PROJECT_DOC_BASE_URL = "https://nevinxu0725.github.io/SmsCode";
